        ...
        <fieldset style="height: 100%;">
            <div class="container_1">
                ...
                <select name="category" required>
                    <option value="" hidden>-Choose Type Announcement-</option>
            ...
            <textarea name="announcement" id="announcement" cols="30" rows="10" required></textarea>
            ...
            <div class="submit">
                <div class="center">
                    <input class="button" type="submit" value="Post" onclick="return myFunction()">
                </div>
            </div>
        </fieldset>
            ...
            ?>
                    ...
                    <table>
                        <tr>
                            ...
                            ?>
                            <tr>
                                <td style="text-align: center;"><input type="checkbox" name="student[]" value="<?php echo $row["id"]; ?>" ></td>
                                <td><?php echo $date; ?></td>
                                <td><?php echo $time; ?></td>
